...
module MediaPipeline
  class CLI < Thor
    ...
    desc 'analyze [storage|database|transcode]', 'Analyze the set of media files to be processed by the pipeline and compute statistics useful for cost analysis'
